<nav x-data="{ open: false }" class="bg-violet-100 dark:bg-gray-800 border-b border-violet-200 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="text-xl font-bold text-violet-600 dark:text-violet-400 tracking-tight">
                        StudyTrack
                    </a>
                </div>
